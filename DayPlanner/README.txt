...
This program is used to create a day planner that will hold different activities that the user has to do at school, home and other locations.

Limitations:
-can only store the activities in a file at the end if QUIT is selected from the command menu 

Building the program:
- press file, project properties, run and type 1 or 2 file names under arguments
- build the program by opening the files on netbeans and pressing the green play button on the top bar
...
If I had extra time I would do more extras
